    ...
    <main class="p-4">
        <section class="space-y-6">
            ...
            <article class="space-y-6">
                <div>
                    <h2 class="text-azul text-center text-3xl md:text-4xl leading-tight">Potencia tu <strong class="text-4xl md:text-xl">WhatsApp</strong></h2>
                </div>
                <div class="text-gray-800 text-xs leading-relaxed text-center">
                    <p>Con funciones avanzadas como listas <span class="font-bold"> personalizadas, mensajes automáticos y
                            seguimientop en tiempo real</span>. Todo en una interfaz simple y fácil de usar.
                    </p>
                </div>

                <div class="grid grid-cols-2 grid-rows-2 gap-4">
                    <div class="bg-azul feature-card">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <article class="text-center w-full px-5">
                <div clas>
                    <h2 class="text-azul text-center text-3xl md:text-4xl leading-tight">Elije tu mejor plan</h2>
                </div>
                <div class="flex text-white flex-col gap-12">
                    <div class="bg-azul rounded-lg h-9 ">
                        <span class="text-xs">
                            Basico
                        </span>
                        <h2 class=""></h2>
