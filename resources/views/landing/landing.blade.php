...
<body class="font-arista">
    ...
    <main class="p-4 max-w-screen-lg mx-auto">
        <section class="space-y-6">
            ...
            <article class="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0 lg:space-x-4">
            ...
            <article class="text-center w-full px-5">
                ...
                <div class="flex text-white flex-col md:flex-row justify-around gap-12 mt-8">
                    <div class="bg-azul rounded-lg py-4 px-6 text-center">
